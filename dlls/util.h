...
#define		BLOOD_COLOR_PANTHER	(BYTE)145
...
extern void			UTIL_Spark( const Vector &position );
...
#define SF_BREAK_NOFALL			512		// spawn item at mins with no gravity
#define	SF_BREAK_NOTSOLID		1024	// no collision (for scripting purposes)

// ammo
#define SF_AMMO_NOFALL		0x0002
#define SF_AMMO_INDRAWER	0x0004
#define SF_AMMO_TRACECHECK	0x0008
