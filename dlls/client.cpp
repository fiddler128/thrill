...
void ClientPrecache( void )
{
	...
	PRECACHE_SOUND("player/h2odeath.wav");	// quake h2o death sound

//	PRECACHE_SOUND("player/heartbeat1.wav");	// heartbeat sound
		...
		if ( pl )
		{
			...
			if ( pl->m_pActiveItem )
			{
				...
				if ( gun && gun->UseDecrement() )
				{
					...
					{
						cd->vuser2.z = ( ( CPython * )pl->m_pActiveItem)->m_fSpotActive;
					}
				}
			}
		}
