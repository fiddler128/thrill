...
// via SKILLS.CFG. Any player hivehand tuning must take place in the code. (sjb)
	...
	// syringes
	gSkillData.adrenalineSyringeCarry = GetSkillCvar( "sk_adrenaline_carry" );
	gSkillData.radSyringeCarry = GetSkillCvar( "sk_radiation_carry" );
	gSkillData.antidoteSyringeCarry = GetSkillCvar( "sk_antidote_carry" );
	...
	// Longjump battery charging speed
	gSkillData.LJChrgSpeed = GetSkillCvar( "sk_longjumpbat" );
}
