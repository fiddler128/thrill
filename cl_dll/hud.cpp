...
//	m_pCvarDrawHoles = CVAR_CREATE( "hud_drawholes", "0", FCVAR_ARCHIVE );
...
//	m_hsprFont = LoadSprite("sprites/%d_font.spr");
	...
	m_HUD_amnumber_0 = GetSpriteIndex( "amnumber_0" );
	
	m_HUD_bord = gHUD.GetSpriteIndex( "bord" );
//	m_hBord = gHUD.GetSprite(m_HUD_bord);
//	m_prcBord = &gHUD.GetSpriteRect(m_HUD_bord);
